...
from parsing_service import get_parse_status, write_parse_status
...
def run_method_in_subprocess(timeout, *args):
    ...
    command = [python_executable, "-c", f"from parsing_service import parse; parse({','.join(map(repr, args))})"]
